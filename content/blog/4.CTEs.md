...
- the output of CTE can be reused as it's about is saved which is better than a sub-query that every time gets recomputed
- KNOWING SUB-QUERIES is a must for knowing CTES as it's a way to make your sub-query reusable hence your overall query faster and more readable
---
## When to Use CTEs
